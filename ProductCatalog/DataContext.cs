...
public sealed class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>().HasData(
            new Product { Id = new Guid("ca173802-206e-4a88-a6cc-2ac93e590fba"), Name = "Футболка", Cost = 100 },
            new Product { Id = new Guid("304e34b1-5267-433a-8d7d-a0abd761da11"), Name = "Шорты", Cost = 200 },
            new Product { Id = new Guid("35e52d12-62f8-4451-ab81-b549fa3f066b"), Name = "Носки", Cost = 50 },
            new Product { Id = new Guid("388ea4e6-f760-4735-9aa5-e3df9906b49c"), Name = "Трусы", Cost = 70 }
        );
    }
}
